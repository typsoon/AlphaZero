...
void print_inference_server_usage(const char *program_name) {
    std::cerr << "Usage: " << program_name
              ...
              << "  --chess-encoder-flip-white  ChessEncoderV2History only: mirror the "
                 "board top/bottom relative to the engine-zoo reference's actual row "
                 "orientation. Do NOT set for checkpoints transplanted from engine-zoo "
                 "(the default, off, already matches the reference) (default: off)\n"
